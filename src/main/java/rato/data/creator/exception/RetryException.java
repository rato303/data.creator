...
public class RetryException extends RuntimeException {
     ...
     *
     * @param messageKey 入力例外発生時に出力するメッセージのメッセージキー
     *
     * @param factory 入力例外発生後に呼び出される{@link CommandLineService}を生成するファクトリ
     *
     */
    public RetryException(String messageKey, CommandLineServiceFactory<?> factory) {
     ...
     * @param messageKey 入力例外発生時に出力するメッセージのメッセージキー
     *
     * @param paramString {@link ResourceBundle#getBundle(String)}に設定する値
     *
     * @param factory 入力例外発生後に呼び出される{@link CommandLineService}を生成するファクトリ
     *
     */
    public RetryException(String messageKey, String paramString, CommandLineServiceFactory<?> factory) {
        super();
        this.commandLineServiceResultBo = new CommandLineServiceResultBo(factory);
        this.message = ResourceBundle.getBundle(paramString).getString(messageKey);
    }
